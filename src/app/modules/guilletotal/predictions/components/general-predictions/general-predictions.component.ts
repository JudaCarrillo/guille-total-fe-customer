...
@Component({
  selector: 'app-general-predictions',
  templateUrl: './general-predictions.component.html',
  styleUrls: ['./general-predictions.component.scss']
})
export class GeneralPredictionsComponent implements OnInit {
  ...
  getTeamHistory(team: string): string[] {
    return this.matchData[team].history.filter((result: string) =>
